  ...
  public static void main(String[] args) throws IOException, UnsortedException {
    ...
    for (int size : datasetSizes) {
      ...
      for (int i = 0; i < sortingData.length; i++) {
        ...
        // bubbleWriter.write("Count: " + bubbleSort.getCount() + " Comparisons: " +
        // bubbleSort.getComparisons() + " Swaps: " + bubbleSort.getSwaps() + " ");
      }
      bubbleWriter.write("\n");
      ...
      for (int i = 0; i < sortingData.length; i++) {
        ...
        // insertionWriter.write("Count: " + insertionSort.getCount() + " Comparisons: " +
        // insertionSort.getComparisons() + " Swaps: " + insertionSort.getSwaps() + " ");
      }
